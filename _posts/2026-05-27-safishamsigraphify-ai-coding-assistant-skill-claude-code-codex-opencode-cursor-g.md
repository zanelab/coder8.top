...
subtitle: ""
banner:
  image: /assets/images/posts/20260527080120-bb01f192.jpg
  opacity: 0.7
author: zane.deng
...
GitHub: 54557 stars. AI coding assistant skill (Claude Code, Codex, OpenCode, Cursor, Gemini CLI, and more). Turn any folder of code, SQL schemas, R scripts, shell scripts, docs, papers, images, or videos into a queryable knowledge graph. App code + database schema + infrastructure in one graph.
